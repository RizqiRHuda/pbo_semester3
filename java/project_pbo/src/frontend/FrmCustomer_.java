...
public class FrmCustomer_ extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (!(namacustomer.isEmpty() && telepon.isEmpty() && alamat.isEmpty())) {
            Customer cst = new Customer();
            cst.setIdCustomer(Integer.parseInt(txtIdCustomer.getText()));
            cst.setNamacustomer(namacustomer);
            cst.setNoHp(telepon);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        boolean deleteSuccess = cst.delete();

        if (deleteSuccess) {
            kosongkanForm();
            tampilkanData();
        } else {
            JOptionPane.showMessageDialog(null, "Terdapat data pada Customer tersebut");
        }
