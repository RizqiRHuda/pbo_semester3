...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 25, 2022 at 12:41 PM
...
--
-- Dumping data for table `transaksimenu`
--

INSERT INTO `transaksimenu` (`idtransaksimenu`, `idtransaksi`, `idmenu`, `jumlah`) VALUES
(1, 2, 2, 1);
...
--
ALTER TABLE `transaksimenu`
  MODIFY `idtransaksimenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
